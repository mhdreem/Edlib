...
import { ViewTBLShamelEmployeeService } from './view-tbl-shamel-employee.service';
...
export class IGlobalEmployeeList {
    ...
    public static TBLShamelBonusReasonList:TBLShamelBonusReason[]=[];
    public static TBLShamelBonusList:TBLShamelBonus[]=[];
    ...
    constructor(
        ...
        {
            try{
                this.viewTBLShamelEmployeeService.getEmpFullName("").toPromise().then(
                    (res :any) => { // Success
