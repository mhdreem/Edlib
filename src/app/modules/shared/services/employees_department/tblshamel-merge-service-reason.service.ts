...
export class TBLShamelMergeServiceReasonService {
 ...
 List_TBLShamelMergeServiceReason_BehaviorSubject : BehaviorSubject< TBLShamelMergeServiceReason[]>= new  BehaviorSubject< TBLShamelMergeServiceReason[]>([]);
  ...
  fill()  {
    ...
    (
      ...
      (data)=> {
        this.List_TBLShamelMergeServiceReason_BehaviorSubject?.next(data);
