...
export class TBLShamelMiniAreaService {
  ...
  public List_TBLShamelMiniArea_BehaviorSubject:BehaviorSubject<TBLShamelMiniArea[]> = new BehaviorSubject<TBLShamelMiniArea[]>([]);
  ...
  fill()  {
    ...
    (data=>{
      ...
      this.List_TBLShamelMiniArea_BehaviorSubject.next(this.List_TBLShamelMiniArea);
    })     
  }
