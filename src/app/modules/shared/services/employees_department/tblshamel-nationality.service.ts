...
export class TBLShamelNationalityService {
  ...
  public List_TBLShamelNationality_BehaviorSubject:BehaviorSubject<TBLShamelNationality[]> = new BehaviorSubject<TBLShamelNationality[]>([]);
  ...
  fill()  {
    ...
    (data=>
      {
        this.List_TBLShamelNationality = data;
        this.List_TBLShamelNationality_BehaviorSubject.next(this.List_TBLShamelNationality);
      })
